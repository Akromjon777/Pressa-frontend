...
function Order() {
   ...
   function PostOrder(e) {
      ...
      fetch('http://localhost:1717/posts/publish/', {
         method: 'POST',
         body: formData,
      })
         .then((res) => res.json())
               ...
               <div className='top_container'>
                  ...
                  <div className='order_div_order'>
                     ...
                     <div className='order_mini_div_two'>
                        ...
                        <input
                           type='text'
                           onChange={(evt) => setSub(evt.target.value)}
                           placeholder='Ichki yonalish'
                           className='order_div_select_tis'
                        />
                     </div>
                     ...
                     <div className='order_div_order'>
                        ...
                        <div className='order_mini_div_three'>
                           ...
                           <div className='upload'>
                              ...
                              <p>
                                 Yuklanyotgan rasm o’lchami 1080x1080 hajmi 2 mb dan
                                 oshmasin
                              </p>
                           </div>
                           <br />
