...
function Home() {
   ...
   useEffect(() => {
      fetch('http://localhost:1717/admin/accepted')
         .then((res) => res.json())
                           ...
                           <ul ref={speakerClass} className='search__speaker'>
                              <li className='search__speaker--item'>
                                 <input
                                    ...
                                    type='checkbox'
                                 />
                                 <label htmlFor='17' className='search__speaker--label'>
                                    Abdulla Azizov
                                 </label>
                              </li>
                              <li className='search__speaker--item'>
                                 <input
                                    ...
                                    type='checkbox'
                                 />
                                 <label htmlFor='18' className='search__speaker--label'>
                                    Akbar Turdiyev
                                 </label>
                              </li>
                              <li className='search__speaker--item'>
                                 <input
                                    ...
                                    type='checkbox'
                                 />
                                 <label htmlFor='19' className='search__speaker--label'>
                                    Akbar Jumayev
                                 </label>
                              </li>
                              <li className='search__speaker--item'>
                                 <input
                                    ...
                                    type='checkbox'
                                 />
                                 <label htmlFor='20' className='search__speaker--label'>
                                    Begzod Iskandarov
                                 </label>
                              </li>
                              <li className='search__speaker--item'>
                                 <input
                                    ...
                                    type='checkbox'
                                 />
                                 <label htmlFor='21' className='search__speaker--label'>
                                    Baxodir Jalolov
                                 </label>
                              </li>
                              <li className='search__speaker--item'>
                                 <input
                                    ...
                                    type='checkbox'
                                 />
                                 <label htmlFor='22' className='search__speaker--label'>
                                    Sardor Qodirov
                                 </label>
                              </li>
                              <li className='search__speaker--item'>
                                 <input
                                    ...
                                    type='checkbox'
                                 />
                                 <label htmlFor='23' className='search__speaker--label'>
                                    Sohib Sharipov
                                 </label>
                              </li>
                              <li className='search__speaker--item'>
                                 <input
                                    ...
                                    type='checkbox'
                                 />
                                 <label htmlFor='24' className='search__speaker--label'>
                                    Dilmurod Alimbayev
                                 </label>
                              </li>
                              <li className='search__speaker--item'>
                                 <input
                                    ...
                                    type='checkbox'
                                 />
                                 <label htmlFor='25' className='search__speaker--label'>
                                    Dilshod Rahmanov
                                 </label>
                              </li>
                           </ul>
