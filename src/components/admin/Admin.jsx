...
function Admin() {
   ...
   function pendingPosts() {
      fetch('http://localhost:1717/admin/await', {
         method: 'GET',
         headers: {
            token,
         },
   ...
   function accept(e) {
      ...
      fetch('http://localhost:1717/posts/publish/' + id, {
         method: 'PUT',
         headers: {
   ...
   function rejected() {
      fetch('http://localhost:1717/admin/rejected', {
         method: 'GET',
         headers: {
            token,
         },
      ...
      <section className='admin__section'>
         <div className='admin'>
            <div className='admin__bar'>
               ...
               <p className='admin__bar--subtext'>Akromjon © 2022</p>
            </div>
                  ...
                  <div className='admin__header--box'>
                     ...
                     <div className='admin__header--subbox'>
                        ...
                        <div className='admin__header--profil'>
                           ...
                           <p className='admin__header--id'>id:1717</p>
                        </div>
                     </div>
                  </div>
               </div>
                           ...
                           <li key={e.publisher_id} className='admin__card'>
                              ...
                              <ul className='admin__card--subbox'>
                                 ...
                                 <li className='admin__card--text'>
                                    <a href='tel: +998991201010'>{e.contact1}</a>
                                 </li>
