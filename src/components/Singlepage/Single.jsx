...
function Single() {
   ...
   useEffect(() => {
      fetch(`http://localhost:1717/posts/publish/${postId}`)
         .then((res) => res.json())
            ...
            <section className='single'>
               <div className='container'>
                  <div className='single__header'>
                     <img
                        className='single__header--icon'
                        src={home_icon}
                        alt='home_icon'
                     />
                     <Link to='/' className='single__header--link'>
                        {' '}
                        Home
                     </Link>
                  ...
                  <div className='single__wrapper'>
                     <aside className='single__aside'>
                        ...
                        <div className='single__aside--box'>
                           ...
                           <button className='single__aside--share'>
                              <img
                                 className='single__aside--share-icon'
                                 src={share_icon}
                                 alt='share_icon'
                              />
                           ...
                           <div className='single__aside--icons'>
                              ...
                              <a
                                 className='single__aside--link'
                                 href='https://www.instagram.com/najottalim/?hl=ru'
                              >
                              ...
                              <a
                                 className='single__aside--link'
                                 href='https://twitter.com/najottalim'
                              >
                     ...
                     <div className='single__bside'>
                        ...
                        <p className='single__bside--desc'>
                           {post.publisher_description}
                        </p>
                        <img
                           className='single__bside--pic'
                           src={
                              'http://localhost:1717/' + post.publisher_photos
                           }
                           alt='isaev'
                        />
                        ...
                        <div className='single__bside--box'>
                           <a
                              className='single__bside--link'
                              target='_blank'
                              rel='noopener noreferrer'
                              href={
                                 post.publisher_link
                                    ? post.publisher_link
                                    : 'https://youtu.be/X0jAWiFBF-g'
                              }
                           >
                           ...
                           <div className='single__bside--subbox'>
                              <img
                                 className='single__bside--subbox-icon'
                                 src={calendar}
                                 alt='calendar'
                              />
                              <p className='single__bside--subbox-text'>
                                 {post.publisher_date}
                              </p>
                           </div>
                           <div className='single__bside--subbox'>
                        ...
                        <div className='single__comment'>
                           <div className='single__comment--header'>
                              <img
                                 className='single__comment--header--icon'
                                 src={izoh_icon}
                                 alt='izoh_icon'
                              />
                           ...
                           <div className='single__comment--sender'>
                              <img
                                 className='single__comment--pic'
                                 src={women_1}
                                 alt='women_img'
                              />
                              <form action='/' className='single__comment--form'>
                                 <textarea
                                    className='single__comment--form--input'
                                    name='message'
                                    placeholder='Izoh yozing...'
                                 ></textarea>
                                 <button className='single__comment--form--btn'>
                                    Yuborish
                                 </button>
                              </form>
                           </div>
                           <div className='single__comment--messages'>
                              <div className='single__comment--person'>
                                 <img
                                    className='single__comment--person--img'
                                    src={women_1}
                                    alt='women'
                                 />
                                 <div className='single__comment--person--box'>
                                    <h3 className='single__comment--person--name'>
                                       Angella
                                    </h3>
                                    <time className='single__comment--person--time'>
                                       Bugun 15:00
                                    </time>
                                 </div>
                              </div>
                              <div className='single__comment--messages-box'>
                                 ...
                                 <div className='single__comment--messages-subbox'>
                                    <img
                                       className='single__comment--messages-icon'
                                       src={answer_icon}
                                       alt='answer_icon'
                                    />
                                    <p className='single__comment--messages-count'>
                                       Javob berish (12)
                                    </p>
                                 </div>
                              </div>
                           ...
                           <div className='single__comment--messages2'>
                              ...
                              <div className='single__comment--messages-box'>
                                 ...
                                 <button className='single__comment--messages-btn'>
                                    Ko'proq ko'rish...
                                 </button>
                              </div>
                           </div>
